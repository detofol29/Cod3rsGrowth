...
//    [HttpPost]
//    [Route("login")]
//    public string Autenticador([FromBody] Usuario modelo)
//    {
//        //Recuperar o usuário do repositório
//        var usuario = repositorio.ObterTodos(null).FirstOrDefault(x => x.Senha == modelo.Senha);
//        if(usuario == null) { return "Usuário ou senha inválidos"; }
